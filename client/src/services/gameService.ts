...
export class GameService {
    ...
    static async joinGame(gameCode: string, playerName: string): Promise<JoinGameResponse> {
    ...
    static createWebSocketConnection(gameCode: string, playerId: string): WebSocket {
        const ws = new WebSocket(`${this.wsUrl}?gameCode=${gameCode}&playerId=${playerId}`);
